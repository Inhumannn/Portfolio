...
function Home(){
   return(
    <>
      <div className="relative border border-solid bg-[#1e1e1f] rounded-[15px] p-[0px 35px 35px]">
          <div className="bg-[#1e1e1f rounded-[15px]">
            <Header title="À propos de moi" />
            <hr id="w-[250px] h-[3px] bg-[linear-gradient(to right, #056dbb, #0951a8, #090979, #0951a8, #056dbb) ] border-none rounded-[5px] m-[-9px 0 22px]" />
            <main>
              ...
              <section>
                ...
                <div id="disposition-competence">
                  <article className="competence-container">
